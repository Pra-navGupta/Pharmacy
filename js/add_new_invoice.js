...
//   xhttp.onreadystatechange = function() {
//     if(xhttp.readyState == 4 && xhttp.status == 200) {
//       console.log("Sales result : " + xhttp.responseText);
//     }
//   };
//   xhttp.open("POST", "php/add_new_invoice.php?action=add_sale", true);
//   var formData = new FormData();
//   // formData.append("customers_name", customers_name);
//   // formData.append("customers_contact_number", customers_contact_number);
