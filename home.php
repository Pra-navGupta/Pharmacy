      ...
      <div class="container">
            ...
            <?php
              function createSection1($location, $title, $table) {
                ...
                if ($title == "Out of Stock") {
                    $query = "SELECT * FROM $table WHERE QUANTITY < 5";
                }
              ...
              // createSection1('manage_doctor.php', 'Total Doctor', 'doctors');
              // createSection1('records.php', 'Records', 'records');
            ?>
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('book', 'add_doctor.php', 'Add New Doctor');
            // createSection2('book', 'records.php', 'records');
          ?>
